          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Team Building Info Kit!`} <br></br><span className="txt-rotate" dataPeriod="1000" data-rotate='["Hey Team Champion","FIED Club"]'><span className="wrap">{text}</span></span></h1>

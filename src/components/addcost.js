                    ...
                    <div className="addcost-bx wow zoomIn">
                        ...
                        <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme housekeeping-slider">
                            <div className="item">
                                ...
                                <h5>Hotel Deal</h5>
                                <p>If you decide to bring your whole crew along, just throw in an extra RM 250 for the room. This covers the sweet half-price deal we've got going on. It's like a little family discount to make your stay even more awesome! </p>
                            </div>
